...
class TestMedalWinner{
	...
	public static void main(String[] args){
		...
		Athlete goldWinner = medalFactory.getMedal("testing.GoldWinner", "Dave Thomas");
		Athlete silverWinner = medalFactory.getMedal("testing.SilverWinner", "Mac McDonald");
		Athlete bronzeWinner = medalFactory.getMedal("testing.BronzeWinner", "David Edgerton");
		
		Athlete goldWinner2 = medalFactory.getMedal("testing.GoldWinner", "Ray Kroc");
